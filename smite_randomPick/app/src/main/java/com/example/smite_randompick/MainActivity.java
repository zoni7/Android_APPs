...
public class MainActivity extends AppCompatActivity {
    ...
    private String [] mages = {"Ao Kuang", "Agni", "Afrodita", "Zeus", "Anubis", "Ra", "Cronos", "Isis", "Kukulkan", "Ah Puch", "Hel", "Freya", "Jano", "Nox", "Hades", "Nu Wa", "Poseidon", "Vulcano", "Change", "Escila", "He Bo", "Raijin", "Sol", "Baba Yaga", "Baron Samedi", "Discordia", "Merlin", "Olorun", "Persephone", "The Morrigan", "Thoth", "Hera" } ;
    private String [] hunters = {"Apolo", "Ah Muzen Cab", "Hou Yi", "Neith", "Anhur", "Artemisa", "Cupido", "Xbalanque", "Medusa", "Skadi", "Rama", "Quiron", "Ullr", "Cernunnos", "Hachiman", "Heimdallr", "Chernobog", "Izanami", "Jing Wei"};
    private String [] anyRoles = {"Tsukuyomi","Ares", "Baco", "Atenea", "Sobek", "Geb", "Silvano", "Ymir", "Cabrakan", "Jepri" , "Xing Tian", "Cerberus" , "Cthulhu" , "Kuzembo" , "Yemoja" , "Fafnir" , "Ganesha" , "Jormungander", "Terra", "Kumbhákarna", "Artio" ,"Sun Wukong", "Chaac", "Guan Yu", "Belona", "Tyr", "Amaterusa", "Hércules", "Odín" , "Osiris", "Vámana", "Nike", "King Arthur", "Erlang Shen", "Cu Chulainn", "Achiles", "Mulan", "Horus", "Loki", "Fenrir", "Awilix", "Ratatoskr", "Mercurio", "Hun Batz", "Nemesis", "Aracne", "Bakasura", "Bastet", "Thor", "Kali", "Ze Zha", "Ravana", "set", "Thanatos","Camazotz", "Da ji", "Pele", "Serqet", "Susano", "Ao Kuang", "Agni", "Afrodita", "Zeus", "Anubis", "Ra", "Cronos", "Isis", "Kukulkan", "Ah Puch", "Hel", "Freya", "Jano", "Nox", "Hades", "Nu Wa", "Poseidon", "Vulcano", "Change", "Escila", "He Bo", "Raijin", "Sol", "Baba Yaga", "Baron Samedi", "Discordia", "Merlin", "Olorun", "Persephone", "The Morrigan", "Thoth", "Hera" , "Apolo", "Ah Muzen Cab", "Hou Yi", "Neith", "Anhur", "Artemisa", "Cupido", "Xbalanque", "Medusa", "Skadi", "Rama", "Quiron", "Ullr", "Cernunnos", "Hachiman", "Heimdallr", "Chernobog", "Izanami", "Jing Wei"}; ;
